...
\begin{theorem}
  Let $U(n)$ be the group of units in $\Z_n$. Then $|U(n)|=\phi(n)$.
\end{theorem}
\begin{theorem}
...
\textbf{Proposition:} Let $G$ and $H$ be groups. The set $G\times H$ is a group. The group $G\times H$ is called the external direct product of $G$ and $H$.
...
\begin{theorem}
  Let $G$ be the intrnal direct product of subgroups $H$ and $K$. Then $G$ is isomorphic to $H\times K$.
\end{theorem}
...
\begin{theorem}
  Let $\phi:G\to H$ be a grop homomorphism. Then the kernel of $\phi$ is a normal subgroup of $G$.
\end{theorem}
